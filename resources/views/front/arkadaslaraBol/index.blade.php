...
<html lang="tr">
  ...
  <body>
        ...
        <div class="card">
          ...
          <div class="transaction-detail">
            <div class="transaction-header">
              ...
              <div class="transaction-info">
                <div class="transaction-business" id="transactionBusiness">Starbucks Kadıköy</div>
                <div class="transaction-date" id="transactionDate">15 Aralık 2024, 14:30</div>
              </div>
              <div class="transaction-amount" id="transactionAmount">₺127.50</div>
            </div>
            ...
            <div class="transaction-description">
              <div class="description-label">Açıklama:</div>
              <div class="description-text" id="transactionDescription">
                Kahve ve atıştırmalık alışverişi. 2x Latte, 1x Croissant, 1x Cookie
              </div>
            </div>
          </div>
          ...
          <div class="summary-section">
            ...
            <div class="summary-item">
              ...
              <span class="summary-value" id="summaryTotalAmount">₺127.50</span>
            </div>
            <div class="summary-item">
            ...
            <div class="summary-item" style="border-top:1px solid var(--border); padding-top:8px; margin-top:8px;">
              ...
              <span class="summary-value" id="summaryYourShare" style="color:var(--accent);">₺127.50</span>
            </div>
          </div>
        </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        // Mock arkadaş verisi (gerçek uygulamada API'den gelecek)
        const mockFriends = [
            { id: 1, name: 'Ahmet Yılmaz', phone: '+90 555 123 4567', avatar: '/images/avatars/1.jpg' },
            { id: 2, name: 'Ayşe Demir', phone: '+90 555 234 5678', avatar: '/images/avatars/2.jpg' },
            { id: 3, name: 'Mehmet Kaya', phone: '+90 555 345 6789', avatar: '/images/avatars/3.jpg' },
            { id: 4, name: 'Fatma Öz', phone: '+90 555 456 7890', avatar: '/images/avatars/4.jpg' },
            { id: 5, name: 'Ali Çelik', phone: '+90 555 567 8901', avatar: '/images/avatars/5.jpg' },
            { id: 6, name: 'Zeynep Arslan', phone: '+90 555 678 9012', avatar: '/images/avatars/6.jpg' }
        ];
        ...
        function updateSelectedFriendsDisplay() {
            ...
            selectedFriends.forEach(friend => {
                const transactionAmount = 127.50; // Sabit tutar
                let amount = 0;
                let percentage = 0;
                ...
                selectedFriend.innerHTML = `
                    <div class="selected-friend-avatar">${friend.name.charAt(0)}</div>
                    <div class="selected-friend-info">
                        <div class="selected-friend-name">${friend.name}</div>
        ...
        function updatePercentageOptions() {
            ...
            selectedFriends.forEach(friend => {
                ...
                percentageItem.innerHTML = `
                    <div class="percentage-label">${friend.name}</div>
        ...
        function updateCustomOptions() {
            ...
            selectedFriends.forEach(friend => {
                ...
                customItem.innerHTML = `
                    <div class="custom-label">${friend.name}</div>
        ...
        function updateShareSummary() {
            ...
            selectedFriends.forEach(friend => {
                ...
                summaryHTML += `
                    <div class="summary-item">
                        <span class="summary-label">${friend.name}</span>
        ...
        function shareBill() {
            const transactionAmount = 127.50; // Sabit tutar
            const businessName = 'Starbucks Kadıköy'; // Sabit işletme adı
            ...
            const shareData = {
                ...
                transactionDate: '15 Aralık 2024, 14:30',
                description: 'Kahve ve atıştırmalık alışverişi. 2x Latte, 1x Croissant, 1x Cookie',
