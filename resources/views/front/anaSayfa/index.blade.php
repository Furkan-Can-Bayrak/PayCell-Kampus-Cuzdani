  ...
  <head>
    ...
    <style>
      ...
      * { box-sizing: border-box; }
      ...
      .budget-icon { width:36px; height:36px; border-radius:8px; display:grid; place-items:center; font-weight:700; font-size:16px; background:rgba(255,204,0,.15); color:#ffcc00; }
      ...
      .budget-progress { margin-bottom:8px; }
      ...
      .progress-fill.market { background:linear-gradient(90deg, #22c55e, #16a34a); }
      .progress-fill.food { background:linear-gradient(90deg, #f59e0b, #d97706); }
      .progress-fill.entertainment { background:linear-gradient(90deg, #8b5cf6, #7c3aed); }
      .progress-fill.bills { background:linear-gradient(90deg, #ef4444, #dc2626); }
      .budget-percentage { font-size:12px; font-weight:600; color:var(--accent); text-align:right; }
        ...
        <div class="main">
          ...
          <div style="margin-top:16px" class="card">
            ...
            <div class="budget-grid">
              <div class="budget-card market">
                <div class="budget-header">
                  <div class="budget-icon">🛒</div>
                  <div class="budget-name">Market</div>
            </div>
                <div class="budget-amount">₺ 245,50</div>
                <div class="budget-limit">₺ 500,00</div>
                <div class="budget-progress">
                  <div class="progress-bar">
                    <div class="progress-fill market" style="width: 49.1%"></div>
                  </div>
                </div>
                <div class="budget-percentage">%49</div>
              </div>

              <div class="budget-card food">
                <div class="budget-header">
                  <div class="budget-icon">🍽️</div>
                  <div class="budget-name">Yemek</div>
                </div>
                <div class="budget-amount">₺ 180,75</div>
                <div class="budget-limit">₺ 300,00</div>
                <div class="budget-progress">
                  <div class="progress-bar">
                    <div class="progress-fill food" style="width: 60.25%"></div>
                  </div>
                </div>
                <div class="budget-percentage">%60</div>
              </div>

              <div class="budget-card entertainment">
                <div class="budget-header">
                  <div class="budget-icon">🎬</div>
                  <div class="budget-name">Eğlence</div>
                </div>
                <div class="budget-amount">₺ 95,00</div>
                <div class="budget-limit">₺ 200,00</div>
                <div class="budget-progress">
                  <div class="progress-bar">
                    <div class="progress-fill entertainment" style="width: 47.5%"></div>
                  </div>
                </div>
                <div class="budget-percentage">%48</div>
              </div>

              <div class="budget-card bills">
                <div class="budget-header">
                  <div class="budget-icon">⚡</div>
                  <div class="budget-name">Fatura</div>
                </div>
                <div class="budget-amount">₺ 320,00</div>
                <div class="budget-limit">₺ 400,00</div>
                <div class="budget-progress">
                  <div class="progress-bar">
                    <div class="progress-fill bills" style="width: 80%"></div>
                  </div>
                </div>
